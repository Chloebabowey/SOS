...
public class CombatMode extends Application implements GameMode {
	...
	public CombatMode(Barricade bar){
		barricade = bar;
	}
	...
	public void start(Stage primaryStage) {
		...
		confirmMove.setOnAction(new EventHandler<ActionEvent>() {
			@Override public void handle(ActionEvent event) {
				...
				gamePlay.combatModeMove(primaryStage, gamePlay.getMoveRow(), gamePlay.getMoveColumn(), gamePlay.getLetterMove());
				if(barricade.isMultiplayer() && sender != null) {
