...
public class ClassicMode extends Application implements GameMode{
	...
	public void start(Stage primaryStage) {
		...
		confirmMove.setOnAction(new EventHandler<ActionEvent>() {
			@Override public void handle(ActionEvent event) {
				...
				gamePlay.classicModeMove(primaryStage, gamePlay.getMoveRow(), gamePlay.getMoveColumn(), gamePlay.getLetterMove());
				System.out.println("clicked a move " + barricade.isMultiplayer() + " " + sender);
				if(barricade.isMultiplayer() && sender != null) {
